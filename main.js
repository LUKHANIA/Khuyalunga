/*=============== SHOW MENU ===============*/
const navMenu = document.getElemmentbyId('nav-menu'),
...
window.addEventListner('scroll', bgHeader)
bgHeader()
...
window.addEventListner('scroll', scrollUp)
scrollUp()
...
window.addEventListner('scroll, scrollActive')
